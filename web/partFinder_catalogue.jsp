...
<html>
<head>
    <title>PartFinder Catalogue</title>
...
<script type="text/javascript">
    ...
    function getPartFinderCatalogue() {
        $.ajax({
            type: 'post',
            dataType: 'text',
            async: true,
            url: 'partFinderCatalogue.action',
    ...
    function getSearchValues() {
        var data = Ext.getCmp('partFinder_catalogue').getStore().getSource();
        return JSON.stringify(data);
    }

    function initCatalogue(result) {
        Ext.create('Ext.grid.property.Grid', {
            id: 'partFinder_catalogue',
...
//            Headers: 'center',
    ...
    Ext.onReady(getPartFinderCatalogue);
</script>
</body>
</html>
