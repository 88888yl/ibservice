...
<html>
<head>
    <title>Dispatch Catalogue</title>
...
<script type="text/javascript">
    ...
    function getDispatchCatalogue() {
        $.ajax({
            type: 'post',
            dataType: 'text',
            async: true,
            url: 'dispatchCatalogue.action',
    ...
    function getSearchValues() {
        var data = Ext.getCmp('dispatch_catalogue').getStore().getSource();
        return JSON.stringify(data);
    }

    function initCatalogue(result) {
        Ext.create('Ext.grid.property.Grid', {
            id: 'dispatch_catalogue',
    ...
    Ext.onReady(getDispatchCatalogue);
</script>
</body>
</html>
