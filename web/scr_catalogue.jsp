...
<script type="text/javascript">
    ...
    function getSCRCatalogue() {
        $.ajax({
            type: 'post',
            dataType: 'text',
            async: true,
            url: 'scrCatalogue.action',
    ...
    function getSearchValues() {
        var data = Ext.getCmp('scr_catalogue').getStore().getSource();
